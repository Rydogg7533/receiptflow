            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
              ...
              {!isSubscribed ? (
                <div className="text-center py-12">
                  ...
                  <p className="mt-4 text-gray-500 dark:text-gray-400">Subscribe to start uploading</p>
                  <p className="text-sm text-gray-400 dark:text-gray-500">Get unlimited receipt extractions</p>
                </div>
              ) : (
                <DocumentList />
              )}
